...
import com.beantechs.libnetwork.utils.CharacterHandler;
import com.beantechs.libnetwork.utils.LogUtils;
...
public class DefaultFormatPrinter implements FormatPrinter {
    private static final String TAG = "BeanHttpLog";
    ...
    private static final String[] ARMS = new String[]{"-B-", "-E-", "-A-", "-N-"};
    ...
    /**
     * 对 {@code app_common_header} 按规定的格式进行处理
     *
     * @param header
     * @return
     */
